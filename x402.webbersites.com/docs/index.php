...
$PAGE_META = [
  ...
  'lint-javascript'   => ['JavaScript Lint API',               'Real V8 syntax check + deterministic JS/Node bug checks'],
  'lint-php'          => ['PHP Lint API',                      'SQL-injection detection and PHP bug checks — never executed'],
